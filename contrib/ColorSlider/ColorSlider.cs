...
namespace MB.Controls
{
    ...
    public partial class ColorSlider : Control
    {
        ...
        /// <summary>
        /// Called when the user has finished dragging the slider and the mouse has been released.
        /// </summary>
        public event TrackBarFinishEvent TrackBarFinished = delegate { };

        /// <summary>
        /// Called when the user presses the mouse down on the slider.
        /// </summary>
        public event EventHandler SliderGrabbed = delegate { };
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            if (ValueChanged != null) ValueChanged(this, new EventArgs());
            Invalidate();
            this.TrackBarFinished(new TrackBarFinishEventArgs(this.Value));
        }
